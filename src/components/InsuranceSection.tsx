        ...
        <div className="max-w-5xl mx-auto">
          ...
          <div className="mb-8 max-w-lg mx-auto">
            <div className="relative">
              <input
                ...
                className="w-full px-4 py-3.5 pl-11 rounded-2xl bg-slate-50 border border-slate-300 text-slate-900 text-xs sm:text-sm focus:border-[#00529b] focus:ring-2 focus:ring-[#00529b]/20 outline-none transition-all placeholder:text-slate-400 shadow-sm"
              />
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-3 sm:gap-4 mb-8">
            {filteredPlans.map((plan) => (
              <motion.div
                key={plan.name}
                layout
                className="flex items-center justify-between p-4 rounded-2xl bg-slate-50/90 border border-slate-200/90 hover:border-[#00529b]/40 hover:bg-white transition-all shadow-sm group"
              >
                <div className="flex items-center gap-3 min-w-0">
                  ...
                  <div className="min-w-0">
                    <div className="font-bold text-sm text-[#002147] group-hover:text-[#00529b] transition-colors truncate">
                      {plan.name}
                    </div>
          ...
          {filteredPlans.length === 0 && (
            <div className="text-center py-8 bg-slate-50 rounded-2xl border border-slate-200 text-xs text-slate-500 mb-8">
              ...
              <a href="tel:3864541156" className="text-[#00529b] font-bold underline">(386) 454-1156</a>{' '}
              to verify your network coverage and co-pay tier.
            </div>
          )}

          {/* Billing Reassurance Card */}
          <div className="bg-[#f8fafc] rounded-3xl p-6 sm:p-8 border border-slate-200 flex flex-col sm:flex-row items-center justify-between gap-5 text-center sm:text-left">
            <div>
              <h4 className="text-base sm:text-lg font-bold text-[#002147] mb-1">
